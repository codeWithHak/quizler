          ...
          {step === "upload" && (
            <div className="space-y-8 mt-8">
              <div className="text-center space-y-3 mb-12">
                <h1 className="text-4xl md:text-5xl font-bold tracking-tight">PDF to Quiz</h1>
                <p className="text-lg text-[color:var(--ui-muted)] max-w-md mx-auto">
                  Upload your PDF and we&apos;ll generate a comprehensive quiz instantly
                </p>
              </div>

              <Card className="w-full max-w-md mx-auto border-[color:var(--ui-border)] bg-[color:var(--ui-panel)] backdrop-blur">
                <CardHeader>
                  <CardTitle className="text-[color:var(--ui-fg)]">Upload Your PDF</CardTitle>
                </CardHeader>
